...
def importar_layout_csv(caminho):
    """Função responsável por importar os arquivos CSV de layout do mapa do level"""
...
def importar_tiles_cortados(caminho):
    """Função responsável por importar os gráficos"""
    # Carregar a imagem
...
def importar_arquivos(caminho):
    """Função responsável por importar os arquivos para os tiles animados"""
